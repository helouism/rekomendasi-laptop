...
<head>
    ...
    <meta name="description" content="laptop recommender system, acer,asus, HP,lenovo, knowledge-based filtering, sistem rekomendasi laptop">
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-success text-uppercase mb-1">
                                                Total Laptop pada yang tersedia</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">
                                                <?php echo $total_laptops; ?></div>
                                        </div>
                                        <div class="col-auto">
